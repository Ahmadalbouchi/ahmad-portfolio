        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className=" text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I'm <br /><span className="text-accent">Ahmad AL Bouchi</span>
            </h1>
            <p className="max-w-[500px] mb-9 text-white/80" >
            I excel at designing and developing websites and full-stack projects. I am highly skilled in creating
             user-friendly interfaces and proficient
             in using a wide range of programming languages and technologies.
            </p>
          {/* btn and socials */}
